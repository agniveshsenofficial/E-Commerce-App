...
const PlaceOrder = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      {/* API Calls for choosing payment methods */ }
      switch (method) {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px] '>
        ...
        <input required onChange={onChangeHandler} name='email' value={formData.email} className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="email" placeholder="Your Email Address" />
        <input required onChange={onChangeHandler} name='street' value={formData.street} className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="text" placeholder="House/Block/Street Address" />
        <div className='flex gap-3'>
        ...
        <div className='flex gap-3'>
          <input required onChange={onChangeHandler} name='zipcode' value={formData.zipcode} className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="number" placeholder="Pin/Zip Code" />
        ...
        <input required onChange={onChangeHandler} name='phone' value={formData.phone} className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="number" placeholder="Recipient's Phone Number" />
      </div>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='grid grid-cols-2 lg:grid-cols-3 gap-4 mt-4'>
            ...
            {/*You can remove this comment and paste the code for other payment methods, to get the code just look into the README.md file, the code will be highlighted and ready to use.*/}
